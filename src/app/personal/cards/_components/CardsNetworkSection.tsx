...
import { NetworkIcon, SavingsIcon } from '@/components/icons';
      ...
      <LayoutWrapper>
        ...
        >
          ...
          <span className="mx-2 inline-flex size-[32px] items-center justify-center rounded-full bg-orange-500 p-2 align-middle lg:size-[60px] lg:p-2.5">
            <NetworkIcon className="size-[18px] text-white lg:size-[34px]" />
          </span>
          built for where you spend so your
          <span className="mx-2 inline-flex size-[32px] items-center justify-center rounded-full bg-orange-500 p-2 align-middle lg:size-[60px] lg:p-2.5">
            <SavingsIcon className="size-[16px] text-white lg:size-[30px]" />
          </span>
