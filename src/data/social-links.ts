...
export const socialLinks: FooterSocialLink[] = [
  { label: 'Facebook', href: EXTERNAL_LINK.FACEBOOK, icon: icon.facebook },
  { label: 'X (Twitter)', href: EXTERNAL_LINK.X, icon: icon.x },
  { label: 'Instagram', href: EXTERNAL_LINK.INSTAGRAM, icon: icon.instagram },
  { label: 'LinkedIn', href: EXTERNAL_LINK.LINKEDIN, icon: icon.linkedin },
];
