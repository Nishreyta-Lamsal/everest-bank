...
import type { ProfileBodyBlock as ProfileBodyBlockData } from './ProfileContentSection';

type ProfileBodyBlockProps = {
  block: ProfileBodyBlockData;
};

export default function ProfileBodyBlock({ block }: ProfileBodyBlockProps) {
